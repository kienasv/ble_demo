...
LOG_MODULE_REGISTER(ble_demo, LOG_LEVEL_DBG);
...
K_THREAD_DEFINE(ethernet_task_id, STACKSIZE, ethernet_task, NULL, NULL, NULL,
		7, 0, 0);
K_THREAD_DEFINE(ble_task_id, STACKSIZE, ble_task, NULL, NULL, NULL,
 		3, 0, 0);
